...
class Employee:
    ...
    # Method to evaluate performance based on various criteria
    ...
    # Method to display performance details of an employee
    def display_performance(self):
        print("Employee:", self.name)
        print("Department:", self.department)
        print("Performance Rating:", self.performance_rating)

# Define a class to manage employees and their performance evaluations
class EmployeeExpertSystem:
    ...
    # Method to update performance of an employee
    ...
    # Method to calculate average performance of all employees
    ...
    # Method to display performance details of all employees
